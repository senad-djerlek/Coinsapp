    ...
    <div>
      ...
      <div className="flex">
        <div className="mt-2">
          ...
          <div className="flex items-center justify-around  mt-9 w-full ">
            <PaidOutlinedIcon
              className="w-20"
              fontSize="large"
              color="primary"
            />
            <h1 className="w-24">Price to EUR</h1>
            <h3 className="font-bold w-28">{coin?.price}</h3>
          </div>
          ...
          <div className="flex items-center justify-evenly mt-9">
            <CurrencyBitcoinOutlinedIcon
              ...
              color="primary"
            />
            <h1 className="w-20">Price to BTC</h1>
            <h3 className="font-bold w-20">
          ...
          <hr className="border-t-2 border-indigo-300" />
          <div className="flex items-center justify-around w-3/2 mt-9 w-full">
            <EggOutlinedIcon
              className="w-20"
              fontSize="large"
              color="primary"
