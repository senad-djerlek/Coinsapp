    ...
    <div className="mt-3">
      ...
      <div className="flex max-w-screen">
        <div className="mt-2">
          ...
          <div className="flex items-center justify-around mt-9">
            ...
            <h3 className="font-bold w-40">
              $ {Number(coin?.priceAt).toLocaleString()} {coin?.symbol}
            </h3>
          </div>
          <hr className="border-t-2 border-indigo-300" />
          ...
          <div className="flex items-center justify-around mt-9 ">
            ...
            <h3 className="font-bold w-40">
              ${Number(coin?.supply.supplyAt).toLocaleString()}
            </h3>
          </div>
          <hr className="border-t-2 border-indigo-300" />
          <div className="flex items-center justify-around mt-9">
      ...
      <div className="max-w-screen flex">
        <div className="w-5/12">
          ...
          <div
            className="px-3 pt-3 border border-indigo-600 rounded text-sm ml-3 mb-10 font-serif"
